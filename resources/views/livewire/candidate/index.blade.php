<div>
    <div x-data="{ sidebarOpen: false, userDropdownOpen: false }">
                        ...
                        <div class="flex items-center ms-3">
                            <div x-data="{ userDropdownOpen: false }" class="relative">
                                ...
                                <button @click="userDropdownOpen = !userDropdownOpen"
                                    ...
                                    <span class="hidden md:inline text-sm text-white font-medium">{{ Auth::user()->name }}</span>
                                ...
                                <div x-show="userDropdownOpen" @click.away="userDropdownOpen = false" x-transition
                                    ...
                                    <ul class="py-1 text-sm text-gray-700">
                                        <li>
                                            <a href="#" class="text-white block px-4 py-2 hover:bg-secondary duration-300">Perfil</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                        ...
                                        <li>
                                            <a href="#" class="text-white block px-4 py-2 hover:bg-secondary duration-300">Sair</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="#"
                           class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <x-svg.ui-check class="shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                    ...
                    <li>
                        <a href="#"
                           class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                           >
                            <x-svg.briefcase class="shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                    ...
                    <li>
                        <a href="#"
                           class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                           >
                            <x-svg.file-earmark class="shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                            <span class="flex-1 ms-3 whitespace-nowrap">
                                Candidaturas
                            </span>
                            <span
                    ...
                    <li>
                        <a href="#"
                           class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                           >
                            <x-svg.person-lines-fill class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                            <span class="flex-1 ms-3 whitespace-nowrap">
                                Perfil
                            </span>
                        </a>
                    ...
                    <li>
                        <a href="#"
                           class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                           >
                            <x-svg.logout class="shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                            <span class="flex-1 ms-3 whitespace-nowrap">
                                Sair
                            </span>
                        </a>
        ...
        <!-- Conteúdo -->
        {{-- isso vai ser um x-main-content --}}
