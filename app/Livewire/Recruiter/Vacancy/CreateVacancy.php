...
class CreateVacancy extends Component
{
    ...
    protected function messages(): array
    {
        return [
            ...
            'title.min'            => 'O Título precisa deve ter no mínimo 3 caracteres.',
            'title.max'            => 'O Título precisa deve ter no máximo 255 caracteres.',
            ...
            'company.max'          => 'A Empresa deve ter no máximo 100 caracteres.',
            'stacks.min'           => 'As Stacks devem ter no mínimo 3 caracteres.',
            'stacks.max'           => 'As Stacks devem ter no mínimo 100 caracteres.',
